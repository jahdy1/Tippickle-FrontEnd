...
<?php
//var_dump($el);
$actor_obj = Object::get($el['actor_uid']);
...
$output = str_replace($actor, '<a href="'.$actor_obj->permalink().'">'.$actor.'</a>', $output);
$output = str_replace($actor, $actor_obj->displayName(),$output);
